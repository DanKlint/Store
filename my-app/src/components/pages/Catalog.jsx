            ...
            <div className="row justify-content-center">
                ...
                <>
                    <div className="input-group rounded mb-4" >
                        ...
                        <input type="text" className="form-control rounded me-1 p-3 fs-5 fw-normal opacity-30"
                        placeholder="Поиск" aria-label="Search" aria-describedby="search-addon" 
                        value={searchValue} onChange={handleSearch}/>

                        <button type="button" className='btn btn-outline-dark' id="search-addon">                       
                    ...
                    <div className="buttons d-flex justify-content-left mb-5 pb-5">
                        ...
                        <button className="btn btn-outline-dark me-2" onClick={()=>setFilter(filteredData)}>Всё</button>
                        ...
                        <button className="btn btn-outline-dark me-2" onClick={()=>filterProduct("jewelery")}>Украшения</button>
